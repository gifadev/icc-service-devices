...
def log_mask_pancashiki_wcdma(num_max_items=0x0ff7, layers=[]):
    log_items = [
...
def log_mask_pancashiki_gsm(num_max_items=0x0ff7, layers=[]):
    log_items = [
...
def log_mask_pancashiki_umts(num_max_items=0x0b5e, layers=[]):
    log_items = []
...
def log_mask_pancashiki_lte(num_max_items=0x09ff, layers=[]):
    items_lte = [
...
def log_mask_pancashiki_nr(num_max_items=0x09ff, layers=[]):
    log_items = [
        diag_log_code_5gnr.LOG_5GNR_RRC_MIB_INFO,
        diag_log_code_5gnr.LOG_5GNR_RRC_SERVING_CELL_INFO,
        diag_log_code_5gnr.LOG_5GNR_RRC_CONFIGURATION_INFO,
