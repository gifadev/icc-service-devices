...
def pancashiki_sdm_common_selection(layers=[]):
...
def pancashiki_sdm_lte_selection(layers=[]):
    log_items = [
...
def pancashiki_sdm_lte_selection_ext(layers=[]):
...
def pancashiki_sdm_edge_selection(layers=[]):
...
def pancashiki_sdm_edge_selection_ext(layers=[]):
    return create_sdm_item_selection(0xff)

def pancashiki_sdm_hspa_selection(layers=[]):
    return create_sdm_item_selection(0x06,
...
def pancashiki_sdm_hspa_selection_ext(layers=[]):
