...
from pancashiki.parsers.samsung.sdmcmd import *
from pancashiki.parsers.samsung.sdmcontrolparser import SdmControlParser
from pancashiki.parsers.samsung.sdmcommonparser import SdmCommonParser
from pancashiki.parsers.samsung.sdmlteparser import SdmLteParser
from pancashiki.parsers.samsung.sdmedgeparser import SdmEdgeParser
from pancashiki.parsers.samsung.sdmhspaparser import SdmHspaParser
from pancashiki.parsers.samsung.sdmtraceparser import SdmTraceParser
from pancashiki.parsers.samsung.sdmipparser import SdmIpParser
...
class SamsungParser:
    ...
    def __init__(self):
        ...
        self.logger = logging.getLogger('pancashiki.samsungparser')
    ...
    def init_diag(self):
        ...
        if self.all_items:
            ...
            self.io_device.write(generate_sdm_packet(0xa0, 0x00, sdm_control_message.COMMON_ITEM_SELECT_REQUEST, pancashiki_sdm_common_selection(layers=self.layers)))
            self.io_device.write(generate_sdm_packet(0xa0, 0x00, sdm_control_message.LTE_ITEM_SELECT_REQUEST, pancashiki_sdm_lte_selection(layers=self.layers)))
            self.io_device.write(generate_sdm_packet(0xa0, 0x00, sdm_control_message.EDGE_ITEM_SELECT_REQUEST, pancashiki_sdm_edge_selection(layers=self.layers)))
            self.io_device.write(generate_sdm_packet(0xa0, 0x00, sdm_control_message.HSPA_ITEM_SELECT_REQUEST, pancashiki_sdm_hspa_selection(layers=self.layers)))
            self.io_device.write(generate_sdm_packet(0xa0, 0x00, sdm_control_message.CDMA_ITEM_SELECT_REQUEST, create_sdm_item_selection(0xff)))
